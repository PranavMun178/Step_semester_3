class PayrollAccount {
    ...
    // Public constructor enforcing non-negative opening salary
    public PayrollAccount(double basicSalary) {
        ...
        this.bonus = 0; // Default opening bonus
    }
    ...
    // Method to deduct tax with percentage validation
    ...
    // Getter for read-only access to net salary
