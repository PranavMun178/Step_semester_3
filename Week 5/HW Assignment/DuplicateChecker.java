public class DuplicateChecker {
    ...
    // Checks for duplicate player names using pairwise comparisons
    ...
    public static void main(String[] args) {
        ...
        System.out.println(findDuplicatePick(lineup1)); // Expected: Duplicate Found: Kohli
        System.out.println(findDuplicatePick(lineup2)); // Expected: No Duplicates Found
    }
}